        ...
        <div class="row justify-content-center align-items-center">
                ...
                <div class="why-we-text-area-3">
                    <div class="default-section-title">
                        ...
                        <h3 class=" editabletext" contenteditable="true" name="Section_5_heading"
                            onblur="Section_5_heading_change(this)">More Great Reasons To Choose Noso Broadband Internet
                        </h3>
                    ...
                    <div class="why-we-list-area-3">
                        <ul>
                            <li class=" editabletext" contenteditable="true" name="Section_5_list_1"
                                onblur="Section_5_list_1_change(this)"><i class="flaticon-seen"></i> Fast Connection
                            </li>
                            ...
                            <li class=" editabletext" contenteditable="true" name="Section_5_list_3"
                                onblur="Section_5_list_3_change(this)"><i class="flaticon-seen"></i> Free Installation
                            </li>
            ...
            <div class="col-lg-6 ">
                <div class="why-we-img-3 ">
                    {{-- have to check both images in the backend --}}
                    <img src="assets/images/why-we/ww-3.png" id="sec_5_img__1" style="width:100%; height:100%;" />
                    <img src="" id="sec_5_img__2" style="width:100%; height:100%;" class="d-none"/>
